defmodule Ello.V3.Middleware.StandardizeArguments do
  ...
  @root_fields [:post, :posts, :page_headers, :editorials, :category, :categories, :comments, :loves]
  @query_types [:post_stream, :category_post_stream, :editorial_stream, :category_nav, :find_posts, :find_user, :comment_stream, :love_stream]
