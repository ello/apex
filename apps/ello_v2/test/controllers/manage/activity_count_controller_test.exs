defmodule Ello.V2.Manage.ActivityCountControllerTest do
  ...
  setup %{conn: conn} do
    ...
    _comment1 = Factory.insert(:post, parent_post: post1)
    _love1 = Factory.insert(:love, post: post1)
    repost1 = Factory.insert(:post, reposted_source: post1)
    _repost_comment1 = Factory.insert(:post, parent_post: repost1)
    _repost_love1 = Factory.insert(:love, post: repost1)
    _mention1 = Factory.insert(:post, mentioned_usernames: ["yolo"])
    _follower1 = Factory.insert(:relationship, subject: brand, priority: "friend")
    _following1 = Factory.insert(:relationship, owner: brand, priority: "friend")
    _blocked1 = Factory.insert(:relationship, subject: brand, priority: "block")
